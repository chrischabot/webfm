...
function draw_files()
{
    ...
    $icons = [
        ...
        'word'    => ['doc', 'rtf'],
        'excel'   => ['xls'],
        'media'   => ['mp3', 'mpg', 'mpeg', 'avi'],
        'image'   => ['gif', 'jpg', 'jpeg', 'png', 'svg', 'ico', 'tiff', 'tff', 'swg', 'psd', 'pdd', 'bmp', 'rle', 'eps', 'jpe', 'pcx', 'pct', 'raw', 'dib'],
        'conf'    => ['ini', 'conf', 'cfg'],
        'web'     => ['html', 'htm', 'asp', 'cfm', 'php', 'php3', 'php4', 'php5', 'shtm', 'shtml', 'xhtml', 'xml', 'wdsl', 'xsl', 'rss', 'rdf', 'dtd', 'xsd', 'css', 'js', 'asa', 'tpl', 'wml', 'vtm', 'vtml'],
        'archive' => ['rpm', 'zip', 'rar', 'bz2', 'gz', 'gzip', 'arj', 'lzh', 'tar', 'dep'],
    ];
...
<html>
<head>
<LINK href="<?php echo $conf_images; ?>/fm.css" rel=stylesheet>
...
<?php echo "$total_dirs directory(s) and $total_files file(s) in ".format_size($total_size).'. Diskspace : '.
...
<div class="taskheader">
	...
	<div class="taskicon"><img src="<?php echo $conf_images; ?>/task_view.gif" width="32" height="32"></a></div>
	<div class="tasktitle">Browsing <?php echo $current_path; ?></div>
</div>
</td></tr>
<?php
